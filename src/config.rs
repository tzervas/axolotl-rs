...
const fn default_lora_r() -> usize {
    64
}
const fn default_lora_alpha() -> usize {
    16
}
...
const fn default_val_split() -> f32 {
    0.05
}
...
const fn default_epochs() -> usize {
    3
}
const fn default_batch_size() -> usize {
    4
}
const fn default_grad_accum() -> usize {
    4
}
const fn default_lr() -> f64 {
    2e-4
}
const fn default_warmup() -> f32 {
    0.03
}
const fn default_grad_norm() -> f32 {
    1.0
}
const fn default_save_steps() -> usize {
    500
}
const fn default_log_steps() -> usize {
    10
}
