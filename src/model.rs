...
/// # Errors
///
/// Returns an error if model loading fails (not yet implemented).
...
/// # Errors
///
/// Returns an error if adapter merging fails (not yet implemented).
...
/// # Errors
///
/// Returns an error if model download fails (not yet implemented).
